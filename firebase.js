...
// Carga devoluciones — implementación real en dashboard.js
// Esta función es un stub para garantizar que firebase.js pueda llamarla
// aunque dashboard.js no esté cargado aún.
async function _loadDevoluciones() {
  // La implementación real vive en dashboard.js y overridea esta función.
